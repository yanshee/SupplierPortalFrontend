          ...
          <tbody>
            {currentData.map((row, index) => (
              <tr key={index}>
                ...
                <td>{row.asnStatus==='Submitted'?<div><button className='ItemListing-Edit-btn' value={row.asnId} onClick={onASNClick}>Click to Dispatch</button></div>:<p>{row.asnStatus}</p>}</td>
