...
const OnboardingSubmission=( { prevStep, nextStep, handleChange, values } )=>
{
    ...
    return (
        <div class='OnboardingMain-container'>
            ...
            {/* {
                currentData?.onboarding_msg != '' || currentData?.onboarding_msg !=null ? <b>Verification Message - 
                <input class="onboarding_message" type="text" value={currentData?.onboarding_msg} disabled></input> </b>
                :<p>Thank you for your Submission . Verification will commence soon. <a href='/SubsLogin'>Login</a> to check the progress</p>
                } */}
                {
               ...
               : <b>Verification Message - <input class="onboarding_message" type="text" value={currentData?.onboarding_msg} disabled></input></b>}
                ...
                {/* {
                  currentData?.onboarding_msg !='' ? <b>{currentData?.onboarding_msg} </b> : <p></p>
                }  */}
            </div>
